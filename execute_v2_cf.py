...
def run_optimization(req_truth, objective_dict):
    tic = time.time()
    ...
    while current_time < end_scenario:
        ...
        Q['Double Park'] = pd.concat(
            [req_incoming_tau['Double Park'], req_old_no_tau['Double Park'], req_old_yes_tau['Double Park'],
             req_old_yes_future_tau['Double Park']])
        Q['Cruising'] = pd.concat(
            [req_incoming_tau['Cruising'], req_old_no_tau['Cruising'], req_old_yes_tau['Cruising'],
             req_old_yes_future_tau['Cruising']])
        Q['Potential Cruising Time'] = pd.concat(
            [req_incoming_tau['Potential Cruising Time'], req_old_no_tau['Potential Cruising Time'], req_old_yes_tau['Potential Cruising Time'],
             req_old_yes_future_tau['Potential Cruising Time']])
